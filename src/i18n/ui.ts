      ...
      jobs: [
        {
          ...
          description: 'Architecting a multi-tenant SaaS desktop app with role-based permissions, offline-first IndexedDB data layer, custom UI framework, Electron cross-platform deployment, and real-time data grids.',
          dotClass: 'bg-primary',
        },
        {
          ...
          description: 'Built dynamic web interfaces with React.js, Next.js, and Vue.js; enhanced SEO via SSR/SSG; scaled a 500K-user e-commerce platform in Mexico with AWS caching and infrastructure optimization.',
        ...
        },
        {
          ...
          description: 'Delivered full-stack digital solutions using JavaScript, Vue, React, and Node.js/Express.js; built robust REST APIs and managed MySQL/SQL databases.',
      ...
      jobs: [
        {
          ...
          description: 'Arquitectura de una aplicación SaaS multi-tenant de escritorio con permisos por roles, capa de datos offline con IndexedDB, framework de UI personalizado, despliegue multiplataforma con Electron y paneles de datos en tiempo real.',
          dotClass: 'bg-primary',
        },
        {
          ...
          company: 'DDB Software Agency',
          period: '09/2023 — 06/2025',
          description: 'Desarrollé interfaces web con React.js, Next.js y Vue.js; mejoré el SEO con SSR/SSG; escalé una plataforma de e-commerce con más de 500,000 usuarios en México con optimización de caché y AWS.',
          dotClass: 'bg-primary/40',
        },
        {
          title: 'Desarrollador Fullstack',
          company: 'Vinix Code',
          period: '11/2020 — 07/2023',
          description: 'Desarrollé soluciones digitales full-stack con JavaScript, Vue, React y Node.js/Express.js; construí APIs robustas y gestioné bases de datos MySQL y SQL.',
          dotClass: 'bg-primary/20',
        },
      ],
    },
